...
Phase 1 exists because newspaper pages carry multiple stories and are fairly long.
Passing full pages into Phase 2 would flood the context with noise, inflate costs, and slow the pipeline.

Right now, Phase 1 is the slowest part of Chronicle and adds an additional $1.50 per query, on average.
...
We collected 1,589 documents that are relevant to all these queries. 
It cost $7 dollars to generate their rich summaries.
